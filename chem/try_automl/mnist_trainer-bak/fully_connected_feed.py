...
flags.DEFINE_integer('batch_size', 128, 'Batch size.  '
                     'Must divide evenly into the dataset sizes.')
flags.DEFINE_string('train_dir', '/apdcephfs/share_698083/gethinhu/mnist_dataset', 'Directory to put the training data.')
  ...
  with tf.Graph().as_default():
    ...
    for step in xrange(FLAGS.max_steps):
      ...
      if step % 100 == 0:
        ...
        print('time: %s, step = %d, loss = %.2f (%.3f sec)' % (datetime.datetime.now(), step + 1, loss_value, duration))
