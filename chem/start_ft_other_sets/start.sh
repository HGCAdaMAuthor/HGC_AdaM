...
--device 0 --epochs 100 --batch_size 32 --gnn_type gin --env jizhi --dataset collab \
--input_model_file /apdcephfs/private_meowliu/ft_local/gnn_pretraining/pt_saved_model/contrast_sim_based_vallina_shuffle_true_soc_set_soft_other_sim_other_dataset_3_gnn_gin_20.pth \
--no_val \
> $log_dir/out.log 2>&1
