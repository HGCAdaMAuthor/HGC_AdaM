...
from mol2features import atom_to_vocab
from mol2features import bond_to_vocab
...
def build():
    ...
    parser.add_argument('--vocab_save_folder', required=False, type=str)
    ...
    # fin = open(args.data_path, 'r') # python MolVocab.py --data_path ./dataset/zinc_standard_agent/processed/smiles.csv --vocab_save_folder ./dataset/zinc_standard_agent/processed --vocab_max_size 300
    # lines = fin.readlines()

    for vocab_type in ['atom', 'bond']:
        vocab_file = "{}_vocab.pkl".format(vocab_type)
