...
--device 0 --epochs 100 --batch_size 32 --gnn_type gin --env jizhi --dataset hiv \
...
# contrast_sim_based_multi_pos_v3_sample_stra_rwr_hop_pos_neg_on_big_graph_bat_5_num_neg_samples_7_T_1_sel_other_stra_last_one_hop_5_rstprob_0.2_p_0.7_q_0.6_rw_hops_10_num_path_11_dl_other_p_w2v_neg_p_no_automl_21.pth