        ...
        # if val_acc > best_val_acc:
            ...
            if test_acc > args.besttestacc:
                torch.save(model.state_dict(), os.path.join(save_eval_model_folder,
                                                           "contrast_hie_gra_lr_{:.4f}_rw_hops_{:d}_num_path_{:d}_gnn_{}_tr_ep_{:d}.pth".format(args.lr, args.rw_hops, args.num_path, args.val_dataset, train_epoch)))

    return best_test_acc, best_epoch

# saved_model/contrast_hie_gra_lr_0.0026_rw_hops_4_num_path_7_gnn_clintox_tr_ep_
import json
def main():
    # Training settings
