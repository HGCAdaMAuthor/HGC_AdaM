...
log_dir=/apdcephfs/share_1142145/meowliu/$TASK_FLAG/$METRICS_TRIAL_NAME
mkdir -p $log_dir

python3 /apdcephfs/share_1142145/meowliu/gnn_pretraining/finetune_automl.py \
--device 0 --epochs 100 --batch_size 32 --gnn_type gin --env jizhi --dataset clintox \
--input_model_file /apdcephfs/share_1142145/meowliu/gnn_pretraining/pt_saved_model/contrast_sim_based_multi_pos_v3_sample_stra_rwr_hop_pos_neg_on_big_graph_bat_5_num_neg_samples_7_T_1_sel_other_stra_last_one_hop_5_rstprob_0.2_p_0.7_q_0.6_rw_hops_2_num_path_5_dl_other_p_w2v_neg_p_no_automl_6.pth \
--no_val \
--othera \
> $log_dir/out.log 2>&1
