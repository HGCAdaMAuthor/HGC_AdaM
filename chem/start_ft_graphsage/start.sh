...
--device 0 --epochs 100 --batch_size 32 --gnn_type graphsage --env jizhi --dataset bbbp \
--input_model_file /apdcephfs/private_meowliu/ft_local/gnn_pretraining/pt_saved_model/contrast_sim_based_multi_pos_v3_sample_stra_rwr_hop_pos_neg_on_big_graph_bat_5_num_neg_samples_7_T_1_sel_other_stra_last_one_hop_5_rstprob_0.2_p_0.7_q_0.6_rw_hops_4_num_path_7_dl_other_p_w2v_neg_p_no_automl_gnn_graphsage_7.pth \
--no_val \
> $log_dir/out.log 2>&1
# --val_dataset bbbp # --data_para
# contrast_sim_based_multi_pos_v3_sample_stra_rwr_hop_pos_neg_on_big_graph_bat_5_num_neg_samples_7_T_1_sel_other_stra_last_one_hop_5_rstprob_0.2_p_0.7_q_0.6_rw_hops_2_num_path_5_dl_other_p_w2v_neg_p_mask_times_5_mask_rate_0.1500_gnn_graphsage_6.pth
