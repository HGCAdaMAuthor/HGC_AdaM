...
from dataloader import DataLoaderSubstructContext, DataLoaderMasking, DataLoaderContrast
...
def main():
    ...
    dataset = ContrastDataset("dataset/" + args.dataset, args=args, dataset=args.dataset,
                              transform=ContrastMask1(num_atom_type = 119, num_edge_type = 5, mask_rate = args.mask_rate, mask_edge=args.mask_edge))
    loader = DataLoaderContrast(dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
