...
def main():
    ...
    if args.split == "scaffold":
        ...
        train_dataset, valid_dataset, test_dataset = scaffold_split(dataset, smiles_list, null_value=0, frac_train=args.train_ratio,
                                                                    frac_valid=1. - args.train_ratio - args.test_ratio, frac_test=args.test_ratio)
        print("scaffold")
    ...
    #         wf.write("gnn_type: {}, dataset: {}, train_ratio: {:.4f}, best epoch: {:d}, best acc: {:.4f}.\n".format(args.gnn_type, args.dataset, args.train_ratio, best_epoch, best_test_acc))
    #         wf.close()
