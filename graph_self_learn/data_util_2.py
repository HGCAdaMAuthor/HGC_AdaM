...
def _create_graphs_from_local_file(dataset_name):
...
def create_node_classification_dataset(dataset_name):
    if "airport" in dataset_name:
        ...
        return SSSingleDataset("/apdcephfs/private_meowliu/ft_local/gnn_pretraining/data/panther/", dataset_name)
    else:
