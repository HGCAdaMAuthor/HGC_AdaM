...
# python 3.7.6 torch 1.4.0 rdkit 2020.03.3 dgl 0.5.3 sklearn 0.22.1
...
def main(args):
    ...
    # for epoch in range(200):
        ...
        if epoch % 1 == 0:
            if args.finetune:
                ...
                print("{:d}\tloss:{:.4f}\tf1:{:.4f}".format(epoch, valid_loss, valid_f1))
        # save model
    ...
    if args.finetune:
        ...
        # print(best_acc)
        print('time: %s, acc = %.4f' % (
            datetime.datetime.now(), valid_f1))
        return valid_f1
